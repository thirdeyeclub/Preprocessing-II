...
## Task 4: Desk Updates Needed
* [xx ] Review the [desk design file](design-files/fun-bus-desk.png).  Notice the navigation, header, and buttons at the bottom of the page are missing.
...
* [ ] Style the site to look good at all sizes, not just desk and phone
